export function privacy() {
  return (
    <div>
      <h1>Privacy Policy for footballmaniac</h1>

      <p>
        At footballmania, accessible from footballmaniac.netlifyapp.com, one of
        ...
        footballmania and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in footballmania. This policy is not applicable to
      ...
      <p>
        footballmania follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of footballmania.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on footballmania, which are sent
      ...
      <p>
        Note that footballmania has no access to or control over these cookies
      ...
      <p>
        footballmania's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        footballmania does not knowingly collect any Personal Identifiable
